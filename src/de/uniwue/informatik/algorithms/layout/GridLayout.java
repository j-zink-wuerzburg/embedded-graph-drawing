 ...
 */
public interface GridLayout<V, E> extends Function<V,GridPoint> {
	 ...
	 */
	void setInitializer(Function<V,GridPoint> initializer);
     ...
     */
	void setLocation(V v, GridPoint location);
